...
func RunningSpentCalories(action int, weight, duration float64) float64 {
	...
	runningSpentCalories := runningCaloriesMeanSpeedMultiplier * runningMeanSpeed * runningCaloriesMeanSpeedShift * weight
	runningSpentCalories /= mInKm
	runningSpentCalories *= duration * minInH
...
func WalkingSpentCalories(action int, duration, weight, height float64) float64 {
	// ваш код здесь
	walkingMeanSpeedKmH := meanSpeed(action, duration)
	walkingMeanSpeedMSec := walkingMeanSpeedKmH * kmhInMsec
	walkingSpentCalories := math.Pow(walkingMeanSpeedMSec, 2)
	heightInM := height / cmInM
	walkingSpentCalories /= heightInM
	walkingSpentCalories *= walkingSpeedHeightMultiplier * weight
	walkingSpentCalories += walkingCaloriesWeightMultiplier * weight
	walkingSpentCalories *= duration * minInH
...
func SwimmingSpentCalories(lengthPool, countPool int, duration, weight float64) float64 {
	// ваш код здесь
	swimmingSpentCalories := swimmingMeanSpeed(lengthPool, countPool, duration)
	swimmingSpentCalories += swimmingCaloriesMeanSpeedShift
	swimmingSpentCalories *= swimmingCaloriesWeightMultiplier * weight * duration
